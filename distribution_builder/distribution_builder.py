...
def distributionBuilder(df_name, pp_info, Screen, stim, min=0, max=250, scale_length=0.8, precision=100, points=50,
    ...
    if len(kwargs)>0:
        ...
        added_vars = 0
    continue_img = pygame.image.load("material//img//continue.png").convert_alpha()  # load the continue-button image
    continue_mouseover_img = pygame.image.load("material//img//continue_mouseover.png").convert_alpha()
